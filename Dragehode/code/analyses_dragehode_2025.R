#This document contains scripts to performed data analyses for the project EffektovervC%king - dragehode in 2025. 
#Downloading, cleaning and merging of data in Folder survey123-vegetation-data, scripts 1_From_survey123_to_dirty_table, 2_Table diagnostics and cleaning, and 3_data_cleaning_and_dataset_merging.
...
df <- readxl::read_excel("~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum/Data/Effekt_dragehode_cleaned/Dragehode_2025_cleaned.xlsx")
...
p.richness <- df %>% 
  ...
  guides(fill = guide_legend(title="SkjC8tsel")) +
  scale_fill_manual(values=c("#004F71","#E57200","#008C95")) +
  labs(x = "SkjC8tsel", y = "Antall karplantearter") +
  scale_y_continuous(expand = c(0, 0))

ggsave(plot = p.richness, filename = "~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum//Output/species_richness_25.jpeg", width = 12, height = 8, units = "cm")
...
ggsave(plot = p.nectar_dekning, filename = "~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum/Output/nectar_dekning_25.jpeg", width = 12, height = 8, units = "cm")
...
ggsave(plot = p.dragehode, filename = "~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum/Output/dragehode_count_25.jpeg", width = 12, height = 8, units = "cm")
...
ggsave(plot = p.dragehode_dekning, filename = "~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum/Output/dragehode_cover_25.jpeg", width = 12, height = 8, units = "cm")
...
ggsave(plot = p.dragehode_all, filename = "~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum/Output/dragehode_all_25.jpeg", width = (24), height = (16), units = "cm")
...
p.dragehode_classes <- df %>% 
  ...
  theme_classic() +
  theme(strip.background = element_blank()) +
  guides(fill = guide_legend(title = "StC8rrelsesklasse")) +
  scale_fill_manual(values = c( "#2DCCD3","#7A9A01","#93328E"),
                    labels = c("smC%planter", "vegetative", "fertile")) + 
  labs(x = "SkjC8tsel", y = "Antall dragehodeplanter") +
  scale_y_continuous(expand = c(0, 0), limits = c(0,50))

ggsave(plot = p.dragehode_classes, filename = "~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum/Output/dragehode_classes_25.jpeg", width = (12*1.5), height = (8*1.5), units = "cm")
...
#Add treatment (slC%tt), dragehode and year information to NMDS results
...
p.dragehode_nmds <- ggplot(nmds_scores, aes(x = NMDS1, y = NMDS2, color = Treatment)) +
  ...
  labs(color = "SkjC8tsel", shape = "Cr", linetype = "Cr") +
  theme_classic() +
...
ggsave(plot = p.dragehode_nmds, filename = "~/Mounts/P-Prosjekter2/154027_effektovervaking_av_trua_arter_og_naturtyper_2024/03 Dragehode/Dracocephalum/Effektovervaaking-Dracocephalum/Output/dragehode_nmds_2025.jpeg", width = (20), height = (16), units = "cm")
